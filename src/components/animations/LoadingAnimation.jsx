...
const StyledWrapper = styled.div`
  width: 100%;
  height: 100vh; /* 👈 Important: make it visible */
  overflow: hidden;
  background-color: #1b2e4b; /* fallback */
  ...
  .container::before {
    ...
    background:
      ...
      linear-gradient(
        ...
        1em 1em / 2em 2em;
    opacity: 0.5;
    animation: BulePipedFloat 20s linear infinite;
  }
